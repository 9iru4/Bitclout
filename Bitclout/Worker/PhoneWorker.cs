...
namespace Bitclout.Worker
{
    ...
    public static class PhoneWorker
    {
        ...
        public static PhoneNumber GetPhoneNumber(ServiceCodes serviceCode)
        {
            ...
            WebRequest request = WebRequest.Create("https://smshub.org/stubs/handler_api.php?api_key=" + ApiKey + "&action=getNumber&service=" + serviceCode.ToString() + "&operator=any&country=" + MainWindowViewModel.settings.SMSCountry.SMSCode);
